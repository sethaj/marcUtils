<xsl:stylesheet version="1.0"
 ...
 <xsl:strip-space elements="*"/>
  ...
  <!-- Only HEB records have an 035 so this is safe for now to rely on inserting the 024
  immediately before 035 in a generic XSLT file meant to be used for any collection.
  If other collections' records start including 035, or seomthing between 024 and 035,
  then we'll either need another test or move this into an HEB-specific stylesheet. -->
